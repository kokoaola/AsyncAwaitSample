...
///各Taskブロックは独立した非同期処理を表しており、ファイルの読み込み、ネットワークリクエスト、およびシステム通知の監視など、異なるタイプの操作を並行して実行
import Foundation
import UIKit
import _Concurrency
import CoreLocation
...
//ファイルハンドルから非同期にバイトを読み込み、Asyncシーケンスで１文字ごとのバイトを出力
